...
-----------                       -----------                       -----------                        -----------
Open Chrome                       Open Chrome                       Open Chrome                        Open Chrome
Navigate to 'site.com'            Navigate to 'site.com'            Navigate to 'site.com'             Navigate to 'site.com'
Click ['Sign In']                 Click ['Sign In']                 Click ['Sign In']                  Click ['Sign In']
Type 'joe' into [username box]    Type 'bob' into [username box]    Type 'mary' into [username box]    Type 'baduser' into [username box]
Verify success                    Verify success                    Verify success                     Verify error


Test Case 5                       Test Case 6                       Test Case 7                        Test Case 8
-----------                       -----------                       -----------                        -----------
Open Firefox                      Open Firefox                      Open Firefox                       Open Firefox
Navigate to 'site.com'            Navigate to 'site.com'            Navigate to 'site.com'             Navigate to 'site.com'
Click ['Sign In']                 Click ['Sign In']                 Click ['Sign In']                  Click ['Sign In']
Type 'joe' into [username box]    Type 'bob' into [username box]    Type 'mary' into [username box]    Type 'baduser' into [username box]
Verify success                    Verify success                    Verify success                     Verify error
...
Test Case 9                       Test Case 10                      Test Case 11                       Test Case 12
-----------                       ------------                      ------------                       ------------
Open IE                           Open IE                           Open IE                            Open IE
Navigate to 'site.com'            Navigate to 'site.com'            Navigate to 'site.com'             Navigate to 'site.com'
Click ['Sign In']                 Click ['Sign In']                 Click ['Sign In']                  Click ['Sign In']
Type 'joe' into [username box]    Type 'bob' into [username box]    Type 'mary' into [username box]    Type 'baduser' into [username box]
Verify success                    Verify success                    Verify success                     Verify error
...
await driver.wait(until.elementLocated(By.id('#username-box')), 10000);
let usernameBox = await driver.findElement(By.id('#username-box'));
await usernameBox.sendKeys('bob');
await driver.wait(until.elementLocated(By.id('#success-element')), 10000);
