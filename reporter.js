...
class Reporter {
     ...
     */
    generateReport() {
        let stateObj = this.generateStateObj();
        if(stateObj.tree.branches.length == 0) {
            return "";
        }
        else {
            function stringify(obj) {
                return utils.escapeHtml(JSON.stringify(obj));
            }
    ...
    /**
     * @return {Object} Object containing the current state of the tree and runner
     */
    generateStateObj() {
